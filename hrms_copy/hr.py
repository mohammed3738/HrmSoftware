...
class AdvanceMaster(models.Model):
    ...
    paid_amount_db = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    remaining_amount_db = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    def installment_amount(self):
        return self.total_amount / self.total_months
    ...
    def __str__(self):
        return f"{self.employee.first_name} - ₹{self.total_amount} Advance"
...
class AdvanceInstallment(models.Model):
    ...
    def __str__(self):
        return f"{self.advance.employee.first_name} - {self.month.strftime('%b %Y')} - ₹{self.amount}"
