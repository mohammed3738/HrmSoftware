            ...
            <form onSubmit="return false">
              ...
              <div id="submit" class="content text-center pt-3 pt-lg-0">
                ...
                <div class="col-12 d-flex justify-content-between mt-4 pt-2">
                  <button class="btn btn-outline-secondary btn-prev"> <i class="mdi mdi-arrow-left me-2"></i> <span class="align-middle d-none d-sm-block">Previous</span> </button>
                  <button class="btn btn-success btn-submit"><span class="align-middle d-none d-sm-block">Submit</span><i class="mdi mdi-check ms-2"></i></button>
                </div>
              </div>
            </form>
          </div>
